...
#define i2c_write(a, b, c, d) i2cWrite(a, b, c, d)   // arduino_i2c_write(a, b, c, d)
#define i2c_read(a, b, c, d)  i2cRead(a, b, c, d)   // arduino_i2c_read(a, b, c, d)
#define delay_ms  delay_ms  // arduino_delay_ms
#define get_ms(...)    do {} while (0)  // arduino_get_clock_ms
#define log_i(...)     do {} while (0)  // _MLPrintLog
#define log_e(...)     do {} while (0)  // _MLPrintLog
